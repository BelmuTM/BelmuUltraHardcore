...
public class Main extends JavaPlugin implements Listener {
    ...
    public static List<String> game = new ArrayList<>();
    ...
    public static boolean startTeams;
    ...
    public static String getMode() {
        return Main.getInstance().getConfig().get("UHC" + "." + "Mode").toString();
    }

    public static String getTeamPicking() {
        return Main.getInstance().getConfig().get("UHC" + "." + "TeamPicking").toString();
    }
